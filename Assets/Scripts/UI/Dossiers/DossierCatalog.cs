        ...
        public static readonly Dictionary<string, DossierDef> All = new()
        {
            ["ally"] = new DossierDef
            {
                ...
                facts =
                {
                    ...
                    new DossierFact { price = 100, text = "The silver locket she never takes off holds a photo of her father. Thomas Quinn wrote for the Gazette. He died when she was thirteen.",
            ...
            ["gerald"] = new DossierDef
            {
                ...
                facts =
                {
                    ...
                    new DossierFact { price = 200, gatedOnEpisodeClose = true,
                                      text = "He checks Ally's ribs when he hugs her. Old habit. He has been inspecting her for damage since she was thirteen.",
            ...
            ["del"] = new DossierDef
            {
                ...
                facts =
                {
                    ...
                    new DossierFact { price = 150, text = "At twenty-three, a rookie constable, she stood on the Quinn doorstep the night Thomas died. Ally was thirteen. Del has been quietly watching out for her ever since.",
                                      reward = Special(SpecialId.SearchWarrant, "Search Warrant") },
                    new DossierFact { price = 200, gatedOnEpisodeClose = true,
