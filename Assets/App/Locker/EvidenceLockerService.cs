...
namespace AQ.App.Locker
{
    ...
    public static class EvidenceLockerService
    {
        ...
        private static readonly List<OverflowTileData> _items = new();
        ...
        public static int Count { get { EnsureLoaded(); return _items.Count; } }
        ...
        public static bool TryStore(OverflowTileData data)
        {
            EnsureLoaded();
        ...
        private static void EnsureLoaded()
        {
            ...
            try
            {
                ...
                if (dto != null)
                {
                    if (dto.items != null) _items.AddRange(dto.items);
        ...
        private static void Save()
        {
            try
            {
                var dto = new DTO { items = new List<OverflowTileData>(_items), purchasedSlots = _purchasedSlots };
        ...
        private class DTO
        {
            public List<OverflowTileData> items;
