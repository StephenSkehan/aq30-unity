...
namespace AQ.Domain.Merge.Tests
{
    ...
    // Event buses
    internal sealed class EventBusSpy : IEventBus
    {
        public readonly List<object> Published = new List<object>();
        public void Publish<T>(T e) => Published.Add(e!);
        public IDisposable Subscribe<T>(Action<T> handler) => new Noop();
        private sealed class Noop : IDisposable { public void Dispose() {} }
    }

    internal sealed class TestBus : IEventBus
    {
        public int Count;
        public void Publish<T>(T e) => Count++;
        public IDisposable Subscribe<T>(Action<T> handler) => new Noop();
        private sealed class Noop : IDisposable { public void Dispose() {} }
    }
