# Audio Investigation — Ep1 Requirement Map (DRAFT for sign-off)
*v1 · 2026-07-17 · integration design for the opening-family swap (art spec: item-icon-regeneration-kit v1.3 Part 4). Blocked on: Stephen's sign-off (this doc) + audio family art delivery.*

Shorthand: A=audio_investigation · F=forensic_tools · R=rusty_anchor · D=food_gifts.
T1-equivalents: T2=2 · T3=4 · T4=8 · T5=16 · T6=32.

## 1 · Requirement re-flavor (L1/L2/L3/L5)
...
L4/L6–L12 unchanged. Requirement `label` strings update with the GUID swaps.
...
- Family totals: forensic 68 → 40 T1eq · audio 0 → 28 · rusty 56 · food 20. **Episode total unchanged: 144 T1eq.** Rewards untouched (1,365 CC + 40 energy + 5 ingots). Pinch model holds — same tap count, same energy.
...
## 4 · Decisions needed (sign-off)

1. **Lab grant at L4** — or earlier (L2/L3)?
2. **L5 fully audio** (as drafted) — or mixed `A-T4 + F-T3` to debut the freshly granted lab immediately?
3. **Optional bookend:** L12's ceremonial F-T2 → A-T2 (episode closes at the mic, mirroring L1). Same T1eq; default = leave as forensic.
...
4. Requirement GUID + label swaps on L1/L2/L3/L5; `generatorRewardTypeId: gen_investigation_lab` on Lead_E1_Bridge.
