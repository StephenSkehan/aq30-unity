...
*Echoes of Havenbay · v4 (logic-and-structure pass) 2026-07-12 · conforms to episode-writers-prompt.md v2 + pilot-spec relaxations*
...
| 11 | f2_delcruz | Interview | Make It Official | D12 Fri | L10 | forensic tools — the intake packet, indexed and bagged | Standard |
| 12 | f2_close | Podcast | The Ferryman, Part One | D13 Sat | L11 | ceremonial: one low-tier press item — "press Publish" | Very Hard (milestone: +500 CaseCash, +20 energy, +3 ingots) |
...
11. *A probable homicide, a falsified file, a live operation. Interview room three. Del Cruz is listening.*
...
| 3 | Ally | worried | Everything went in under its own name: Rosa's logbook, the second ledger, Priya's tide report, Eddie's gate book — and Eddie himself as a protected witness. The live operation she can't touch without a taskforce. Taskforces leak. We both know where. |
...
| # | Speaker | Emotion | Line |
|---|---|---|---|
| 1 | Ally | neutral | This is Echoes of Havenbay — and as of nine o'clock this morning, the Reyes crossing is open again. A homicide investigation, with a case number and a detective who answers her phone. |
...
**Open decisions for Stephen (before lock):**

1. **The branch point.** The greenlit package expects exactly one choice per episode (Phase 2); Ep2 still has none — the L5 3a/3b nodes are an *echo* of Ep1's flag, not a new choice. Candidates: (a) L7 — open the cashbox on-air vs. privately at Malone's (spectacle vs. chain of custody); (b) L11 — let Del take Eddie in as a protected witness (slower, safer) vs. air the gate-book match immediately (faster, exposes Eddie). Candidate (b) is the stronger argument-starter and rhymes with Ep1's PUBLIC/PROTECTED without repeating it. Needs your call + flag naming.
2. **Rosa's portrait** — approve adding her to the portrait pipeline (prompt block to be written into portrait-prompts-canon-cast.md on approval).
3. **Press/garage art gate** — Ep2 leans on press (L3, L5, L12) and garage (L7) families; both are art-gated today. Fine on the Ep2 timeline (6–8 weeks post-launch), but the icon batches need scheduling.

Remaining before lock: branch decision → table read (performance/timing veto) → numbered-revision passes → VO LOCK; cue sheet and actor sides generate from asset data at production.
