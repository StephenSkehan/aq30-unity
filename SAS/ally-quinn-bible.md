...
> - **★ LIVE 2026-07-18 (46b71a6): Audio Investigation IS the opening family** ("Audio Investigation finds the story. Forensic Tools makes it evidence."). The opening generator is the six-tier **Field Kit** (`gen_field_kit`: pouch → satchel → backpack → hard case → trunk → mobile field unit) — how Ally CARRIES her equipment; it produces audio items only in Ep1. The Investigation Lab is granted at L4. (The drafted 10-tier gen_audio_rig was retired pre-integration — its broadcast gear read too close to the audio items themselves.)
...
**How to use this document.** This bible is the narrative program's home truth — the one place where the world, the season arc, the cast, the episode craft, and the production rules connect. It does not duplicate its masters: dialogue truth lives in locked scripts, roster truth in `canon-character-roster.md`, appearance truth in `portrait-prompts-canon-cast.md`, systems truth in the SAS architecture docs and the economy sheet. Where this bible and a master disagree, the master wins and this bible gets corrected. **Authority is by DOMAIN, not one linear ladder** (clarified 2026-07-18): NARRATIVE conflicts resolve **locked scripts → roster → this bible → prompts/kits → legacy sources**; SYSTEMS/ECONOMY conflicts resolve **live assets/SOs → systems rulings docs (see SAS/CURRENT-STATE.md) → this bible**. The old linear list put systems docs below the bible, which contradicted this paragraph's own first sentence. (Full archaeology in Appendix 9.4.)
...
## 6.2 Episode 2 — "The Ferryman" · DRAFT v7 (STRUCTURE LOCKED 2026-07-12 — table-read candidate)
