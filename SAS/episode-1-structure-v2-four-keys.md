...
| 06 | F2 + A2 (two cards; was F2 + F2, amended 2026-09-02: one package never asks the same item twice) | 4 | 20 | ★TURN [ET] The pact, the same night, and behind the door a second letter: this one didn't say she thought. It said she knew. A thing of hers beside it that two survivors will not name | 54 | Never what the object was |
...
| 04 | F3×2 | 8 | 20 | (t)[AC] The Regent marquee: three of six letters back, the ladder still chained under them, nothing finished. That is how you know she was there | v1.2 | The unfinished job as image, texture only (the ladder has no history since 2026-09-05) |
...
| 08 | R4, R2, R1 | 11 | 45 | (t)[ET] The fall on her record six weeks before she died: a witnessed stumble on the weedy slip, bruised all over, swam anyway; the coincidence nobody called anything, because it was one (Stephen-ruled 2026-09-05; was the ladder) | 21, 22, 55 | The fall as public-inquest fact and Ruby's memory of treating it; never the bolt |
...
| 05 | R4, A3 | 12 | 50 | (t)[ET] PENDING FORGERY REBUILD (2026-09-05): the forged letter's third claim tested against Liam; was "she told everyone which ladder". Replacement set with the forgery | 58 | His answer; nothing else |
...
| 09 | R5, F4, A3 | 28 | 120 | ★TURN [ET] The boat owner's tip: Brad was at her locker at six that Monday morning, fourteen hours before the four opened it together, and told them that night he had only just opened his letter. The dead man went early. To Del the same day, never aired. **D2 resolves here** | 57 (D290) | The tip verbatim; that it goes to Del within the day and is never aired; Ally's private vertigo, unexplained; never what the visit was for, or that anything was swapped |
...
**The jeopardy gate, ruled (Stephen, 2026-09-13; v2.3 note).** The episode is told after the fact by choice, and its danger is misdirected, not absent. The listener and both survivors believe a triple killer is loose in Havenbay and that it is one of the two people Ally is recording. That belief is wrong about who and right about the fact: Brad is alive, has come back once to kill Margo, and by chapter 9 is watching the woman who cleans his room. The perceived danger of the early chapters and the real danger of the late chapters are one danger with the wrong face. **The one-sentence jeopardy, with its clock:** one of the two people on Ally's microphone killed three of their friends, the other believes it and is waiting to be next, and every episode Ally airs tells the killer exactly what she knows. **Four conditions, binding on structure and prose:** (1) both survivors stay plausible to the listener through the middle chapters, each with one thing a listener can hold against them; (2) the fear costs something visible in the played span, shown not stated (Liam will not be in a room with Ruby; Ruby has changed her locks; one of them stops answering Ally for a week); (3) Ally's own exposure, alone with each of them and not knowing which, is the present danger the listener feels; (4) Brad alive is never signalled early; the landlady's countdown (Days 325 to 333) is where misdirected becomes literal. **The cold-open gate** is tested, not argued: the Part H brief of spine v2.0 is read cold to three to five of the twelve testers, who are asked whether they need to hear the rest and whether they would come back tomorrow. This answers the 2026-09-13 critical review's finding that the genre choice was unnamed.

**The agency gate, ruled (Stephen, 2026-09-13; v2.3 note).** The standing rule ("count decisions that change play; fewer than four is a fail") was written against The Listener's single end-gate. Its purpose was that the player's route and the record left behind must diverge more than once, and not only at the close. Two decisions diverge mechanically (D3 forks chapter 7, D4 forks the close: mutually exclusive branch packages of equal mass, different requirements, different beats, different record) and two diverge in what is aired and who speaks to the show (D1: what Ruby's account airs and the garbled leak; D2: Liam's consent and his silence). With the arrest fixed by the spine, that is the divergence the rule was for, and the gate is ruled met on that reasoning, not by count. Fallback held: if the chapter 7 fork is not felt in the first playtest, D1 and D2 are given branch packages of their own (about ten authored packages) and the structure moves to v2.4. This replaces the 2026-09-02 kickoff's bare "the agency gate passes", which the 2026-09-13 critical review correctly found unreconciled.
