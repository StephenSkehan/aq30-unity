...
| −46 night | Brad, with his unit key, undoes the foot bolt on the Regent ladder. | Brad |
...
| −20 | New padlock on her lock-up at the slip boatsheds. Four keys cut at the locksmith on Lantern Street; his book records four copies, that date. | Violet, locksmith |
...
| 82 | The sister, clearing the unit, cuts the padlock on the store. Empty. |
...
| 230 → 250 | The store letter examined against the four key letters and her unit paper: consistent with known samples, same paper stock. |
...
|---|---|---|---|---|---|---|
| 1 | Violet holds cash, in a tin, more than painting explains | Violet, Margo, Brad (the tin, not the size), Liam from Day 2 | Day −1500 | Violet's own act; Margo told for the tax question; Brad saw the tin at the unit | Anyone; Margo owes confidence | None: cash is lawful |
...
| Sister | Tin, house, unit, an empty store at Day 82 | None | | | An empty store is an empty store |
...
| 6 | Does a reader with no context understand every word? | Lock-up, panel, name board, tin, ladder, cliff, train. "Gilding" needs one line. No procedure near the hook. | Pass |
