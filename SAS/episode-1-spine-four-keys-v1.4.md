...
| Violet changes the cage padlock, has four keys cut on Lantern Street, writes five letters, hides panel and letter in the cage, lodges four envelopes with her solicitor: post after my funeral. | −20 to −18 |
...
| Accident. The four keys. Brad reads the cage on Day 16, writes at her bench on Day 17, swaps on Day 18. The panel leaves with him on Day 60 in a bag hidden at the ridge wall. | 1 to 53 |
...
| −20 | New padlock on Cage 4. Four keys cut at the locksmith on Lantern Street; his book records four copies, that date. | Violet, locksmith |
| −19 | Violet writes four key letters and one cage letter, hides panel and letter in the cage. | Violet |
...
| 16 Wed | 05:40 | Brad at Cage 4, market hours, van on the street, the corridor door round the side by the units where no camera looks. Reads the cage letter, takes it and the panel. The fishmonger at Bay 3 says early for you. |
...
| 82 | The sister, clearing the unit, cuts the padlock on Cage 4. Empty. |
...
| 230 → 250 | The cage letter examined against the four key letters and her unit paper: consistent with known samples, same paper stock. |
...
| 290 | 4 | Liam talks. The fishmonger at Bay 3 rings the Tip Line: the young one was at her cage on the Wednesday. Ally gives it to Del and does not air it. |
...
| 27 | Brad went to the cage on the Wednesday and the Friday | Brad; the Bay 3 fishmonger (Wed). The market's one camera covers vehicles in the loading bay, not the corridor door round the side by the units (R25's shape); Brad parked on the street | Day 16, 18 | Sight | Fishmonger: anyone. Nobody asks until Day 290 | If anyone alleging tampering had asked the market before Day 60, the fishmonger would have named Brad. Nobody alleged it |
...
| 52 | The cage letter is consistent with her known samples | HCPD | Day 250 | Examination | Police; the survivors are told | Nothing to act on |
...
| 55 | The letters, the room, the boxes, Brad's habits | Ruby, on record | 270 onward | Yes: Ruby owns her letter and holds the cage letter after its return from police | Ep 2 |
| 56 | The debts being called in; the panel carried round | Café owner, cinema owner, two signwriters | 280 to 304 | Yes | Ep 3, 6, 9 |
| 57 | Brad at the cage on the Wednesday | Bay 3 fishmonger, Tip Line | 290 | Yes, caller consents | To Del. Not aired |
...
|---|---|---|---|---|
| R1 | Two dawn visits to Cage 4 | Bay 3 fishmonger's memory; no camera sees the corridor door | Anyone who asks the market with a tampering allegation or hypothesis (R27); nobody does until Ally on Day 290 | Memory does not die |
...
| 292 | Ally's Day 290 tip: the fishmonger saw Brad at the cage on the Wednesday. Del already holds Tessa's Day 240 line | Under R27 the two together are a tampering hypothesis. Del takes the fishmonger's statement, re-reads the cage letter's examination, runs Brad Collins for any activity since Day 60 | A hypothesis on a closed file with a presumed-dead subject | Brad, presumed drowned, is the only known pre-opening visitor. No activity under his name. No charge possible, no reopening of Violet on a visit to a cage (R19), nothing to tell the survivors that is evidence | Del holds "Brad may have swapped it" privately from Day 292. It reaches nobody: not Ally (the file), not Brad (nothing moves under his name). It is why she moves inside a day on Day 327 |
