...
**Status: the sweep PASSES on one named character lock.** No person's earliest competent action ends the episode before its planned turn except by Margo's choice: from Day 19 she holds the fact that breaks the letter and keeps it for six weeks (C5, the load-bearing refusal). Ruby's open route to Del from Day 27 is computed and does not deliver.
...
| Accident. The four keys. Brad reads the store on Day 16, writes at her bench on Day 17, swaps on Day 18. The panel leaves with him on Day 60 in a bag hidden at the ridge wall. | 1 to 53 |
...
| 14 Mon | | Four keys and four letters arrive. The letter says: I think one of you is planning to kill me, I do not know which, I may be wrong, do not go to the police and here is why, what I found is behind this door, only the four of you can read it. The locker at the slip boatsheds is named. They ring each other that night and agree Saturday. |
| 16 Wed | 05:40 | Brad at the slip boatsheds, van on the slip road; no camera covers the sheds. Reads the store letter, takes it and the panel. A boat owner antifouling before the tide, whose boat Violet lettered and whose tender Brad painted in a hurry, says early for you. |
| 17 Thu | night | Brad at Violet's bench with his workshop key. Her layout paper, her pen. He writes it there, where practice sheets in her style are invisible among her own, with the debt book open beside him for her cursive. Burns the drafts and the book in his sink. Puts the pen back. |
| 18 Fri | 05:30 | Brad places the letter and the name board in the store. |
| 19 Sat | 10:00 | The four open the store. A letter in her hand that says I know, and the name board from her hall. Read at Ruby's kitchen table. Margo asks why the board is here and is answered: she is telling us something. Brad says she might have been wrong about all of it. Weekly meetings agreed. Margo reads the line about the tin and knows it does not square with what Violet told her four years ago. She says nothing: the money was told in confidence, Violet lied fluently about small things, and she cannot yet tell which of them Violet lied to. |
...
| 290 | 4 | Liam talks. The boat owner from the slip sheds rings the Tip Line: the young one was at her store on the Wednesday. Ally gives it to Del and does not air it. |
...
| 27 | Brad went to the store on the Wednesday and the Friday | Brad; the boat owner at the slip sheds (Wed): Violet lettered his boat, Brad did his tender; he knows both signwriters by sight and none of the four socially. No camera covers the sheds; Brad's van on the slip road | Day 16, 18 | Sight | Boat owner: anyone. Nobody asks until Day 290 | If anyone alleging tampering had asked at the sheds before Day 60, the boat owner would have named Brad. Nobody alleged it |
| 28 | What the genuine store letter said: the dosed tin and the loose lid ("I think"; she cannot be sure), the panel, the mark, "I know it's not Brad's work. I taught him everything he knows and I'm not that good a teacher", and an instruction to pool everything odd each of you knows of the others | Brad only | Day 16 | He read it | Nobody | It is ash |
| 29 | The panel is in Brad's possession | Brad | Day 16 | Taken | Nobody | None |
| 30 | The store letter (forged) says I know; the tin is Liam's; the yard; third claim PENDING FORGERY REBUILD (was: the ladder told to Liam); the board; and never mentions a panel or any physical threat | The four, then Ruby's drawer | Day 19 | The store | Anyone; the letter itself says not the police | Del, if handed it on any day from 19: as row 25, examination routine under R22: consistent |
...
| 40 | The three were meeting weekly over letters from the dead woman | The three | Day 19 onward | Their own act | Del at interview Day 62 | If told: Del reads the vanish as a grieving man. If shown the letters: Del reads the vanish as possible guilt, notes it on the closed file, cannot charge a presumed-dead man, cannot reopen a coroner's finding on a text message (Ruling 1). Either way, nothing moves |
...
| 57 | Brad at the store on the Wednesday | The boat owner at the slip sheds, Tip Line | 290 | Yes, caller consents | To Del. Not aired |
...
|---|---|---|---|---|
| R1 | Two dawn visits to the store | The boat owner's memory; no camera covers the sheds | Anyone who asks at the sheds with a tampering allegation or hypothesis (R27); nobody does until Ally on Day 290 | Memory does not die |
| R2 | Her pen and paper used, drafts burned, the debt book burned | Nothing survives; the pen is back in the workshop and goes to the sister | Nobody | Day 17 |
...
| 3 | The key letter | Read the store on the Wednesday, not the Saturday | The store letter says what she reasoned and the panel is there; both must go before four people read them | Do nothing: the four pool what they know and he is the only one with weekends away, cash and a question about the van |
...
| boat owner | Brad at the store, Day 16 | None until asked | Tip Line, Day 290 | To Del | A friend at a dead friend's store is not a thing to report |
