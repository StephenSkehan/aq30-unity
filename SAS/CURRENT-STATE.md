...
*As of 2026-07-18 · branch `claude/ally-quinn-bible-phase-2-p8e642` · **describes commit `46b71a6`** (update the hash when the state changes; strictly ahead of main; landing = Stephen's call). Update this file whenever a ruling lands or an integration flips. If a document below disagrees with this page, this page wins on STATUS; the named master wins on CONTENT.*
