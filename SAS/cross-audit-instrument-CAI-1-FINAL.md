<!-- pdf-title: Mode A Cross-Audit Instrument CAI-1 FINAL -->

# MODE A CROSS-AUDIT INSTRUMENT — CAI-1 FINAL
...
| I5 | `true-crime-genre-anatomy` not used, and the execution record says so |
